        ...
        <v-form>
            <v-container>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm6 md4>
                        <v-text-field
                            v-model="budgetEntryMain.transactionNo"
                    ...
                    <v-flex xs12 sm6 md4>
                        <v-text-field
                            v-model="budgetEntryMain.description"
                            label="Description"
                            readonly>
                    ...
                    <v-flex xs12 sm6 md4>
                        <v-text-field
                            v-model="budgetEntryMain.status"
                            label="Status"
                            readonly>
                        </v-text-field>
                    </v-flex>
...
export default {
    ...
    methods: {
        ...
        accept() {
            this.$axios.post(`${this.apiEndpoint}/accept`, this.budgetEntryMain)
                .then(({ data }) => {
                    toast.show(data);
                })
                .catch(({ response }) => {
        ...
        decline() {
            this.$axios.post(`${this.apiEndpoint}/decline`, this.budgetEntryMain)
                .then(({ data }) => {
                    toast.show(data);
                })
                .catch(({ response }) => {
        ...
        returnEntry() {
            this.$axios.post(`${this.apiEndpoint}/return`,
                 { transactionNo: this.budgetEntryMain.transactionNo, comment: this.comment }
                 )
                 .then(({ data }) => {
                     toast.show(data);
                     this.$router.back();
