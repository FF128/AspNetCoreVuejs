        ...
        <v-container>
                        ...
                        <v-container>
                            <v-layout wrap>
                               ...
                               <v-flex xs12 sm6 md6>
                                ...
                                <v-flex xs12 sm6 md6>
                                    <v-text-field
                                        v-model="budgetEntry.department"
                                        label="Description">
                                    </v-text-field>
                                </v-flex>
                                <!-- Location -->
                               ...
                               <v-flex xs12 sm6 md6>
                                ...
                                <v-flex xs12 sm6 md6>
                                    <v-text-field
                                        v-model="budgetEntry.designation"
                                        label="Description">
                                    </v-text-field>
                                </v-flex>
            ...
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    <td>
                        <v-btn icon
                            @click.prevent="budgetEntryDetails.splice(props.index, 1)">
                            <v-icon color="red">delete</v-icon>
                        </v-btn>
                    </td>
...
export default {
    ...
    methods: {
        ...
        addDetails() {
            ...
            if(typeof item == "undefined" && 
               ...
               //return;
                ...
                item.quantity =  parseInt(item.quantity) + parseInt(this.budgetEntry.quantity);
        ...
        processForm() {
            ...
            this.$axios.post(`${this.apiEndpoint}`, bodyFormData)
                .then(({ data }) => {
                    toast.show(data);
                    this.budgetEntry = { };
                    this.budgetEntryDetails = [];
