        ...
        <template slot="items" slot-scope="props">
          <td>
            <v-btn
              flat
              icon
              @click.prevent="$router.push(`returned-budget-entry/${props.item.transactionNo}`)"
            >
...
export default {
  ...
  methods: {
    ...mapActions("budgetEntryApp", ["getAllReturnedBudgetEntryData"])
  },
  computed: {
  ...
  created() {
    this.getAllReturnedBudgetEntryData();
  }
};
</script>
