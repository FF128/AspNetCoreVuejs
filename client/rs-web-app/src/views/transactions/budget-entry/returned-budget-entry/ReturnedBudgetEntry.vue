  ...
  <div>
    <v-container>
          ...
          <v-form v-model="valid">
            <v-container>
              <v-layout row wrap>
                ...
                <v-flex xs12 sm6 md3>
                  <v-textarea label="Remarks" v-model="budgetEntry.remarks"></v-textarea>
                </v-flex>
              </v-layout>
            </v-container>
          </v-form>
          ...
          <v-form v-model="valid">
            <v-container>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.locName" label="Description"></v-text-field>
                </v-flex>
                <!-- Department -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.department" label="Description"></v-text-field>
                </v-flex>
                <!-- Location -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.location" label="Description"></v-text-field>
                </v-flex>
                <!-- Group Code -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.group" label="Description"></v-text-field>
                </v-flex>
                <!-- Division/Office -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.area" label="Description"></v-text-field>
                </v-flex>
                <!-- Branch -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.branch" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.unit" label="Description"></v-text-field>
                </v-flex>
                <!-- Section -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.section" label="Description"></v-text-field>
                </v-flex>
                <!-- Rank -->
                <v-flex xs12 sm6 md6>
                  <v-text-field
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.rank" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.payHouse" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.region" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.loe" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.project" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field v-model="budgetEntryDetail.designation" label="Description"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  ...
                  <v-text-field
                    ...
                    :rules="requiredRules"
                  ></v-text-field>
                  <v-text-field v-model="budgetEntryDetail.remarks" label="Remarks"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md12>
                  <v-text-field
                  ...
                  <v-data-table hide-actions class="elevation-1" :items="attachments">
                    <template slot="items" slot-scope="props">
                      ...
                      <td>
                        ...
                        <v-btn icon @click.prevent="openFile(props.item)">
      ...
      >
        <template slot="items" slot-scope="props">
          <td>
            <v-btn icon @click.prevent="deleteInfo(props.item)">
              <v-icon color="red">delete</v-icon>
            </v-btn>
          </td>
...
export default {
  ...
  methods: {
    ...
    addDetails() {
      ...
      if (
        ...
        const newArray = Object.assign(
          {},
          this.budgetEntryDetail,
          this.budgetEntryDetail
        );
        this.budgetEntryDetails.push(new Object(newArray));
      } else {
        item.quantity =
          parseInt(item.quantity) + parseInt(this.budgetEntryDetail.quantity);
    ...
    processForm() {
      ...
      this.$axios
        .post(`${this.apiEndpoint}/return-budget`, bodyFormData)
        .then(({ data }) => {
          toast.show(data);
          this.$router.back();
        })
    ...
    getBudgetEntryDetails() {
      this.$axios
        .get(`${this.apiEndpoint}/details/${this.$route.params.transNo}`)
        .then(({ data }) => {
          // this.budgetEntryDetails = data;
          // this.budgetEntry = data.budgetEntryMainHeader;
          this.budgetEntryDetails = data.budgetEntryMaintDetails;
    ...
    getBudgetEntryAttachments() {
      this.$axios
        .get(`${this.apiEndpoint}/attachment/${this.$route.params.transNo}`)
        .then(({ data }) => {
          // this.budgetEntryDetails = data;
          // this.budgetEntry = data.budgetEntryMainHeader;
          // this.budgetEntryDetails = data.budgetEntryMaintDetails
