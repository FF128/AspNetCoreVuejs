...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(this.apiEndpoint, this.jobGroup)
                .then(response => {
                    this.isSaving = false;
        ...
        update() {
            ...
            this.$axios.put(this.apiEndpoint, this.jobGroup)
                .then(response => {
        ...
        deleteConfirmed() {
            ...
            this.$axios.delete(`${this.apiEndpoint}/${this.selectedJobGroup.id}`)
                .then(response => {
                    let { message, hasError } = response.data;
