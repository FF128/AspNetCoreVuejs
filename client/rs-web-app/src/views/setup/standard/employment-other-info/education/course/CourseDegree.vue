            ...
            <v-container>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm6 md8>
                        <v-text-field
                            label="Description"
                            v-model="course.courseDegreeDesc">
        ...
        <v-container>
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    <td>{{ props.item.courseDegreeCode }}</td>
                    <td class="text-xs-left">{{ props.item.courseDegreeDesc }}</td>
                    <td>
                        <v-btn icon
...
export default {
  ...
  methods: {
    ...
    deleteConfirmed() {
      ...
      this.$axios
        .delete(`${this.apiEndpoint}/${this.selectedCourse.courseDegreeCode}`)
        .then(response => {
          toast.show(response.data);
          this.cancel();
