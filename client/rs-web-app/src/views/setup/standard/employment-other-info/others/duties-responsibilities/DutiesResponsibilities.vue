    ...
    <div>
            ...
            <v-container>
                ...
                <v-layout row wrap>
                    <v-flex xs12 sm6 md4>
                        <v-text-field
                            label="Code"
                            v-model="duty.dutiesResponsibilitiesCode">
                    ...
                    <v-flex xs12 sm6 md8>
                        <v-text-field
                            label="Description"
                            v-model="duty.dutiesResponsibilitiesDesc">
        ...
        <v-dialog
            ...
            <v-card>
                ...
                <v-card-text>
                    Do you want to delete this Code: {{ selectedDuty.dutiesResponsibilitiesCode }}?
                </v-card-text>
...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(this.apiEndpoint, this.duty)
                .then(response => {
                    this.isSaving = false;
        ...
        update() {
            ...
            this.$axios.put(this.apiEndpoint, this.duty)
                .then(response => {
        ...
        deleteConfirmed() {
            ...
            this.$axios.delete(`${this.apiEndpoint}/${this.selectedDuty.id}`)
                .then(response => {
                    this.getAllDuties();
