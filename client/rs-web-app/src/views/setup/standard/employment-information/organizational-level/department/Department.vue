        ...
        <v-container>
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-left">{{ props.item.depHeadCode }}</td>
                    <td>
                        <v-btn icon
...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(this.apiEndpoint, this.dep)
                .then(response => {
                    this.isSaving = false;
        ...
        update() {
            ...
            this.$axios.put(this.apiEndpoint, this.dep)
                .then(response => {
        ...
        deleteConfirmed() {
            ...
            this.$axios.delete(`${this.apiEndpoint}/${this.selectedDep.id}`)
                .then(response => {
                    let { message, hasError } = response.data;
    ...
    computed: {
        ...
        ...mapState('department', {
            departmentData: state => state.departments,
