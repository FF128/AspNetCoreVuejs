    ...
    <div>
        ...
        <v-container>
            <v-data-table
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-left">{{ props.item.secHeadCode }}</td>
                    <td>
                        <v-btn icon
        ...
        <v-dialog
            ...
            <v-card>
                ...
                <v-card-text>
                    Do you want to delete this Code: {{ selectedSection.sectionCode }}?
                </v-card-text>
...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(this.apiEndpoint, this.section)
                .then(response => {
                    this.isSaving = false;
        ...
        update() {
            ...
            this.$axios.put(this.apiEndpoint, this.section)
                .then(response => {
        ...
        deleteConfirmed() {
            ...
            this.$axios.delete(`${this.apiEndpoint}/${this.selectedSection.id}`)
                .then(response => {
                    let { message, hasError } = response.data;
    ...
    computed: {
        ...
        ...mapState('section', {
            sectionData: state => state.sections,
