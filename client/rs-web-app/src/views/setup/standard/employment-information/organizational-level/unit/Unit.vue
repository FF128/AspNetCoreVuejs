    ...
    <div>
        ...
        <v-dialog
            ...
            <v-card>
                ...
                <v-card-text>
                    Do you want to delete this Code: {{ selectedUnit.unitCode }}?
                </v-card-text>
...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(this.apiEndpoint, this.unit)
                .then(response => {
                    this.isSaving = false;
        ...
        update() {
            ...
            this.$axios.put(this.apiEndpoint, this.unit)
                .then(response => {
        ...
        deleteConfirmed() {
            ...
            this.$axios.delete(`${this.apiEndpoint}/${this.selectedUnit.id}`)
                .then(response => {
                    this.getAllUnits();
