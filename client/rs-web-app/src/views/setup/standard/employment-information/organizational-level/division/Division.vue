    ...
    <div>
        ...
        <v-dialog
            ...
            <v-card>
                ...
                <v-card-text>
                    Do you want to delete this Code: {{ selectedDiv.divisionCode }}?
                </v-card-text>
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Description", value: "divisionDesc", align: "left" },
  ...
  methods: {
    ...
    save() {
      this.isSaving = true;
      this.$axios
        .post(this.apiEndpoint, this.div)
        .then(response => {
          this.isSaving = false;
    ...
    deleteConfirmed() {
      ...
      this.$axios
        .delete(`${this.apiEndpoint}/${this.selectedDiv.divisionCode}`)
        .then(response => {
          let { message, hasError } = response.data;
    ...
    selectJobLevel(item) {
      this.division.jobLevelCode = item.code;
  ...
  computed: {
    ...
    ...mapState("division", {
      divisionData: state => state.divisions,
