<template>
    <div class="section">
        ...
        <div class="columns">
            <div class="column is-4">
                <b-field label="Code" custom-class="is-small">
                    <b-input size="is-small" v-model="empStatusFile.code"></b-input>
                </b-field>
            </div>
            <div class="column">
                <b-field label="Description" custom-class="is-small">
                    <b-input size="is-small" v-model="empStatusFile.description"></b-input>
                </b-field>
            </div>
        </div>
        ...
        <b-table
            :data="isEmpty ? [] : empStatusFileData"
            :bordered="isBordered"
            :striped="isStriped"
            :narrowed="isNarrowed"
        ...
        <div class="modal" :class="deleteModal | modalStatusFilter"> <!-- Delete Confirmation -->
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    <!-- Content ... -->
                    <h1 class="title is-5">Do you want to delete this information (Code: {{selectedEmpStatusFile.code}})?</h1>
                </section>
                <footer class="modal-card-foot" style="justify-content: flex-end;">
                    <button class="button is-danger" @click="deleteConfirmed(selectedEmpStatusFile)" :class="isDeleting | buttonLoading">Yes</button>
...
export default {
    ...
    methods: {
        ...
        save() {
            this.isSaving = true;
            this.$axios.post(apiEnpoint, this.empStatusFile)
                .then(response => {
                    this.isSaving = false;
        ...
        edit(item){
            this.onEdit = true;
            this.empStatusFile = item;
        },
        update() {
            this.isUpdating = true
            this.$axios.put(apiEnpoint, this.empStatusFile)
                .then(response => {
