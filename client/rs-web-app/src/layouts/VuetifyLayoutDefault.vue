<template>
  <div>
    <v-app id="inspire">
      ...
      <v-navigation-drawer class="white" v-model="drawer" app absolute>
        <!-- <img src="@/assets/banner.png" class="img-responsive"> -->
      ...
      <v-toolbar dark color="primary" app>
        ...
        <v-toolbar-items class="hidden-sm-and-down">
          <v-menu bottom offset-y v-for="(item,key) in menu" v-bind:key="key">
            <v-btn flat slot="activator" @click="changeRoute(item.routeName)">
              {{ item.title }}
...
export default {
  ...
  methods: {
    ...mapActions("routing", ["changeRoute"]),
    logout() {
