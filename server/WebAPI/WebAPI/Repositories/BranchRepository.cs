...
namespace WebAPI.Repositories
{
    public class BranchRepository : IBranchRepository
    {
        ...
        public async Task Delete(string code)
        {
            ...
            {
                await conn.ExecuteAsync("sp_BranchSetUp_DeleteByCode",
                    new { code },
        ...
        public async Task DeleteFileSetUp(string code)
        {
            using (var conn = connectionFactory.Connection)
            {
                await conn.ExecuteAsync("sp_tbl_fsBranch_DeleteByCode",
                    new { code },
                    commandType: CommandType.StoredProcedure);
            }
        }
        ...
        public async Task DeleteFromHRISFileSetUp(DeleteSetUpDto dto)
        {
            using (var conn = connectionFactory.Connection)
            {
                await conn.ExecuteAsync("sp_tbl_fsBranch_DeleteFromHRIS",
                    dto,
                    commandType: CommandType.StoredProcedure);
            }
        }
        ...
        public async Task DeleteFromPayrollFileSetUp(DeleteSetUpDto dto)
        {
            using (var conn = connectionFactory.Connection)
            {
                await conn.ExecuteAsync("sp_tbl_fsBranch_DeleteFromPayroll",
                    dto,
                    commandType: CommandType.StoredProcedure);
            }
        }
        ...
        public async Task DeleteFromTKSFileSetUp(DeleteSetUpDto dto)
        {
            using (var conn = connectionFactory.Connection)
            {
                await conn.ExecuteAsync("sp_tbl_fsBranch_DeleteFromTKS",
                    dto,
                    commandType: CommandType.StoredProcedure);
            }
        }
