...
{
    public class DRController : ApiController
    {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Insert(DutiesAndResponsibilities dr)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IHttpActionResult> Update(DutiesAndResponsibilities dr)
        {
            if (!ModelState.IsValid)
            {
                return Ok();
